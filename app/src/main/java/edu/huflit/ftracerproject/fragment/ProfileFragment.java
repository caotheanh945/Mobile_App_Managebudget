...
import edu.huflit.ftracerproject.activity.Family;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tvLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(getContext(), PickRoleLogin.class);
                startActivity(i);
            }
        });
        tvFamily.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getContext(), Family.class);
                startActivity(i);
            }
        });
        Bundle bundle = getArguments();
        TextView email = view.findViewById(R.id.tvAccount);
        TextView user = view.findViewById(R.id.tvName);
        user.setText(MainActivity.username);
        email.setText(bundle.getString("emailuser"));
    }
}